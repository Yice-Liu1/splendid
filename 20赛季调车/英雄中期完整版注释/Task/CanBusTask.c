...
volatile Encoder HANDMOTOR = {0,0,0,0,0,0,0,0,0};
...
void Set_Current(CAN_TypeDef *CANx,int16_t gimbal_yaw_iq, int16_t gimbal_pitch_iq, int16_t bolun_iq, int16_t friction_iq)
{
    ...
    tx_message.Data[2] = (unsigned char)(gimbal_pitch_iq >> 8);
    tx_message.Data[3] = (unsigned char)gimbal_pitch_iq;
    tx_message.Data[4] = (unsigned char)(bolun_iq >> 8);
    tx_message.Data[5] = (unsigned char)bolun_iq;
    tx_message.Data[6] = (unsigned char)(friction_iq >> 8);
    tx_message.Data[7] = (unsigned char)friction_iq;
    CAN_Transmit(CANx,&tx_message);
}
int test=0,test1=0;
...
//		}
//	}
//	else if(flag_power_over==1)//&&(CM1SpeedPID.ref>2700||CM1SpeedPID.ref<-2700)
//	{
//		if(speed>100)
//		{
//			CM1Speed_x-=5;
