...
char q[16];
uint8_t MPU_id = 0;
 uint16_t MPU_TEM_L=0;
 uint16_t MPU_TEM_H=0;
 uint16_t MPU_TEM_F=0;
 uint16_t MPU_ISP_X_L= 0;
uint16_t MPU_ISP_X_H = 0;
uint16_t MPU_ISP_Y_L= 0;
uint16_t MPU_ISP_Y_H= 0;
uint16_t MPU_ISP_Z_L= 0;
uint16_t MPU_ISP_Z_H= 0;
uint16_t MPU_ISP_X_F=0;
uint16_t MPU_ISP_Y_F=0;
uint16_t MPU_ISP_Z_F=0;
int tem;
...
uint8_t MPU6050_Init(void)
{
  ...
  uint8_t index = 0;
  uint8_t MPU6050_Init_Data[14][2] = 
  {
	...
	{ MPU6050_TEMP_OUT_L   ,0x41},
	{ MPU6050_TEMP_OUT_H   ,0x42},
  };
...
//	
	 //  MPU_TEM_L=MPU6050_Read_Reg(MPU6050_TEMP_OUT_L);
		//MPU_TEM_H=MPU6050_Read_Reg(MPU6050_TEMP_OUT_H);
		//MPU_TEM_F=MPU_TEM_H<<8|MPU_TEM_L;
