...
float Pitch_shell_ki=0;//200 0.001 50 20 50 0.008
float Pitch_shell_kd=0;//20 0,01 0 250 0      180 
float Speed_Pitch;		//速度保留
float pitch_core_kp_out,pitch_core_kd_out;	//内环单项输出
//内环PID参数
float Pitch_core_kp=0;       //4hao 15 5     45
float Pitch_core_kd=0;                      // 60
...
//外环PID参数
float Yaw_shell_kp=60;//1800 0.8 12000 50 350 55
float Yaw_shell_ki=0.01;//100 0.2 500  0.008
float Yaw_shell_kd=20;//180
float Speed_Yaw;		//速度保留
float Yaw_core_kp_out,Yaw_core_kd_out;	//内环单项输出
//内环PID参数
float Yaw_core_kp=-30;  //30
float Yaw_core_kd=20;  //100
