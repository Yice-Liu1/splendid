...
float rotationangle1,rotationangle2,r_a1,r_a2;
 float M1,M2,M3,M4,M5,M6,M7,quanshu=0;
int turn1,turn2;
void CAN1_Config()
{
...
{  
    ...
    null = rx_message.Data[7];
							...
							if(Std==0x201)
			{
				...
				rotationangle1=y;
				rotationangle1=(rotationangle1/8191)*360;
				EncoderProcess(&HANDMOTOR1,&rx_message);
		r_a1=HANDMOTOR1.ecd_angle;
						M6=Uspeed_fdb;
					if(fenzhuang==1)
					{
            M6=Fspeed_fdb;
			...
			{
				rotationangle2=y;
				rotationangle2=(rotationangle2/8191)*360;
					EncoderProcess(&HANDMOTOR2,&rx_message);
		r_a2=HANDMOTOR2.ecd_angle;
