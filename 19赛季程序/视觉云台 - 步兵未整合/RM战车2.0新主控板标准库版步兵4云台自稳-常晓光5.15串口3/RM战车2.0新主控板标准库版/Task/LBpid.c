...
//外环PID参数
float Pitch_shell_kp=70;//120      //70
float Pitch_shell_ki=0.05;//0.1    //0.05
float Pitch_shell_kd=60;//100      //60
float Speed_Pitch;		//速度保留
float pitch_core_kp_out,pitch_core_kd_out;	//内环单项输出
//内环PID参数
float Pitch_core_kp=6;             //6
float Pitch_core_kd=10;            //10
...
//外环PID参数
float Yaw_shell_kp=80;//24     //80     //80
float Yaw_shell_ki=0.1;//0.001  //0.1   //0.1
float Yaw_shell_kd=60;//    //40         //60


float Speed_Yaw;		                                       //速度保留
float Yaw_core_i=0;                                      //cml:内环积分项
float Yaw_core_kp_out,Yaw_core_ki_out,Yaw_core_kd_out;     //内环单项输出

float Yaw_core_kp=20;    //50                //20                  //内环PID参数
float Yaw_core_ki=0;
float Yaw_core_kd=20;   //10               //20
...
////////////////////////内环角速度环(PD)///////////////////////////////       
  Yaw_core_kp_out = Yaw_core_kp * (Yaw_shell_out +  GYRO_Yaw * 3.5f);   //cml:
	//Yaw_core_ki_out
...
// out = (int16_t)Yaw_shell_out;
  ...
  if(Yaw_core_out>25000) Yaw_core_out=25000;
	if(Yaw_core_out<-25000) Yaw_core_out=-25000;
