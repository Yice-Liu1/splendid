...
float Kp_pi_po=320;//300;    //cml:pitch轴 角度环PID 参数//180 -5 60 50 10 10
float Ki_pi_po=10;//1.6;
float Kd_pi_po=0;
float out_pi_po=0;


float Kp_pi_sp=9;//71.4;//250//25;
float Ki_pi_sp=7;//14.2;//50//10;
float Kd_pi_sp=10;//16.6;//500//20;
float out_pi_sp=0;
...
/*****************************************************************************************************/
  ...
  error_speed[0] = 	out_pi_po - speed_pitch*20.0f;
