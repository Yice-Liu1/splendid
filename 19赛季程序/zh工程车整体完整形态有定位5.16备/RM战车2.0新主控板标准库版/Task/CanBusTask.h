...
void Arcoss_Vice(CAN_TypeDef *CANx, int16_t arcoss2wheel_iq,int16_t arcoss1wheel_iq, int16_t vice_fwheel_iq, int16_t vice_hwheel_iq);//zh
void Set_GEThand(CAN_TypeDef *CANx, int16_t hand_iq);
void Set_GETarm(CAN_TypeDef *CANx, int16_t arm_iq);
//void Set_GET(CAN_TypeDef *CANx, int16_t arm_iq, int16_t hand_iq);
//void Set_2006(CAN_TypeDef *CANx, int16_t wuminglun_iq);
#endif
