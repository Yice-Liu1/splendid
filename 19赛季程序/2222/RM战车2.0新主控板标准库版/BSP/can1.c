...
u16 Fspeed_fdb,Uspeed_fdb,speed_fdb,Yp,Yy,zhuanju_fdb;//云台角度反馈,yp yy分别对应两个云台的角度fadeback,MX是电机的FEDBACK,全局变量在main.h
uint8_t jiaoduh,jiaodul,zhuansuh,zhhuansul,shiji_currenth,shiji_currentl,temp,null;
uint32_t Std;
int  fenzhuang,y;//quanshu是摩擦轮转的圈数

float M1,M2,M3,M4,M5,M6,M7,M8,quanshu=0;
void CAN1_Config()
{
    // sdf++;
...
void CAN1_RX0_IRQHandler(void)
{
    ...
    null = rx_message.Data[7];
			...
			zhuanju_fdb=((shiji_currenth << 8)|shiji_currentl); //zh:转矩电流
