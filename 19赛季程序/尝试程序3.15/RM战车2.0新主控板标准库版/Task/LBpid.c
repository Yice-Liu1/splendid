...
//外环PID参数
float Pitch_shell_kp=0;//90   70  //改
float Pitch_shell_ki=0;//0.2   1  //改
float Pitch_shell_kd=0;//50   6   //改
...
//内环PID参数
float Pitch_core_kp=0;  //cml:之前版本是15   6//改
float Pitch_core_kd=0;    //cml:之前版本5     5//改
