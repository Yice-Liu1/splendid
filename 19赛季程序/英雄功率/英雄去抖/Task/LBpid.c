...
float Pitch_shell_ki=0.008;//   250 0.2 300 12 200   0.2
float Pitch_shell_kd=80;//   800     500 6  500   500
float Speed_Pitch;		//速度保留
float pitch_core_kp_out,pitch_core_kd_out;	//内环单项输出
//内环PID参数
float Pitch_core_kp=20;       //4hao 15 5    4
float Pitch_core_kd=90;     //   200
...
//外环PID参数
float Yaw_shell_kp=72;//250 0.2 300 0.3 200                      //1000
float Yaw_shell_ki=0.1;//1000 0.02 800  300 0.001 70 4 400        //0.02
float Yaw_shell_kd=60;//                                          //800
float Speed_Yaw;		//速度保留
float Yaw_core_kp_out,Yaw_core_kd_out;	//内环单项输出
//内环PID参数
float Yaw_core_kp=35;        //4
...
//--------------------输出到电机--------------------------------//
	...
	if(Yaw_core_out>=4500)		Yaw_core_out=4500;	
	if(Yaw_core_out<=-4500)	Yaw_core_out=-4500;
